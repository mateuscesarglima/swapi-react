        ...
        <Container>
          <section className="main-section" id="main-section">
            ...
            <div className="card-container grid grid--2-cols grid--center-v">
              <HomeCard title="Planets" number="01" img={planetTatooine} description="Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium fugiat ea dignissimos tenetur, nihil animi? Assumenda delectus repudiandae nam veritatis." />
              <HomeCard
                title="People"
                number="02"
